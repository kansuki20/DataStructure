...
public class BinTree {
	...
	public static void main(String[] args) {
		...
		n1.setLeft(n2); n1.setRight(n3); //n1의 죈쪽자식 n2, 오른쪽자식 n3
		n2.setLeft(n4); n2.setRight(n5);
		n3.setLeft(n6); n3.setRight(n7);
		n4.setLeft(n8);
		
		BinaryTree<Integer> t = new BinaryTree<>(); //이진 트리 객체 t 생성
		t.setRoot(n1);
		...
		n10.setLeft(n20); n10.setRight(n30); //n1의 죈쪽자식 n2, 오른쪽자식 n3
		...
		System.out.print("copy 테스트 : " + BinaryTree.isEqual(t.getRoot(), t3.getRoot()));
		System.out.println();
	}
